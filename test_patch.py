...
betas_patches = np.ones(NUMPATCHES)
...
fig.suptitle('Initialisation of network with "Epicenter" patch with immunity waning')
...
# ani.save('handput_network_animation_waning.gif', writer='pillow', fps=10)
plt.tight_layout()
plt.show()
